...
class MyNNRBFModel2D(gpytorch.models.ExactGP):
    def __init__(
        ...
        # base_covar_module = SK(NNRBFKernel(idim=2, odim=2, layer_sizes=(2,))) + SK(
        #     NNMaternKernel(idim=2, odim=2, layer_sizes=(8, 4), mu=1.5)
        # )
...
class MyVariational2DModel(gpytorch.models.ApproximateGP):
    def __init__(self, train_x, train_y, likelihood, inducing_ratio=1):
        inducing_points = train_x.clone()[::inducing_ratio]
